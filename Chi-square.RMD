...
Replace the `NULL` below with code to calculate Cramer’s V effect size using the `cramersV()` function from the `lsr` package and store this in the object `eff_size`.
